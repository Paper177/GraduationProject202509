...
def main():
    ...
    argparser.add_argument('--yolo_model', metavar='PATH', default='YoloModel/yolo11x.pt', help='YOLO 模型路径')
    ...
    argparser.add_argument('--tl-method', metavar='METHOD', default='hsv', help='红绿灯检测方法 (deep_learning 或 hsv)')
